...
public class StreamClient {
    ...
    public synchronized boolean operateToken(int status) {
        int maxConnectionNum=sparkAiConfig.getQPS();
    ...
    public String getAuthUrl() {
        try {
            URL url = new URL(sparkAiConfig.getHostUrl());
            // 时间
    ...
    public RequestDTO getRequestParam(String uid, List<MsgDTO> msgList) {
        ...
        requestDTO.setHeader(new RequestDTO.HeaderDTO(sparkAiConfig.getAppId(), uid));
        requestDTO.setParameter(new RequestDTO.ParameterDTO(new RequestDTO.ParameterDTO.ChatDTO(sparkAiConfig.getDomain(), sparkAiConfig.getTemperature(), sparkAiConfig.getMaxTokens())));
